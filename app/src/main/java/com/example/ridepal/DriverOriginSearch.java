...
public class DriverOriginSearch extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void geoLocate(Place place){
        ...
        Geocoder geocoder = new Geocoder(DriverOriginSearch.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(DriverOriginSearch.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(DriverOriginSearch.this);
    }
