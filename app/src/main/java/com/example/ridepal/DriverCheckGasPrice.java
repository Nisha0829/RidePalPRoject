...
public class DriverCheckGasPrice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_check_gas_price);
        ...
        cont.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(gasPriceInput.getText().toString().isEmpty()){
                    ...
                    Intent end=new Intent(DriverCheckGasPrice.this, DriverEndTrip.class);
